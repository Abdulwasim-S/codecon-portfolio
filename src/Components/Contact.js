...
const Contact = () => {
  ...
  return (
    <div className="pb-5">
      <div className="heading pt-5 text-start px-5 ">Contact</div>
      <div className="contact pt-3 ">
        <LinkedIn />{" "}
        <a
          className={"text-decoration-none text-" + textMode}
        ...
        <br />
        <br />
        <Email /> <email>abdulwasimsmech@gmail.com</email>
        <br />
        <br />
        <WhatsApp />{" "}
        <a
          className={"text-decoration-none text-" + textMode}
          href="https://wa.me/918778354776"
          target="_blank"
          rel="noreferrer"
        >
          +91-877-835-4776
