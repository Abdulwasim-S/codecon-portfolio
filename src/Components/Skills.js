    ...
    <div>
      ...
      <div className="slider-track">
        <div className="logo-slider ">
          ...
          />
          <img
            src="https://img.icons8.com/?size=512&id=mRiGJYwO8l6B&format=png"
            alt="bootstrap-img"
            className="logo-img p-2"
          />
          <img
            src="https://img.icons8.com/?size=512&id=bzf0DqjXFHIW&format=png"
            alt="react-js-img"
            className="logo-img p-2"
          />
          <img
          ...
          />
          <img
            src="https://img.icons8.com/?size=512&id=GPfHz0SM85FX&format=png"
            alt="java-img"
            className="logo-img "
          />
        </div>
